...
const sections = {
  sections: [
    ...
    },
    {
      ...
      content:
        'I have worked on several personal programming projects over the past few years, including school assignments, work-related projects and personal projects. Click on the button below to learn more about what I have created so far!',
    },
    {
      ...
      href: '/#awards',
      content:
        'I enjoy challenging myself and honing my skills in Computing and other subjects, and have joined several competitions over the past few years. I have won several awards for academic performance and participated in many competitions and olympiads over the years, such as achieving a Silver Medal at the <strong>2019 National Olympiad in Informatics (NOI)</strong>.',
    },
    {
    ...
    },
    {
      ...
      href: '/#personal',
      content:
        'Not only do I program for fun, I also do have a lot of hobbies and interesting facts about myself! This page is dedicated to what I do in my daily life and my hobbies.',
    },
  ],
};
