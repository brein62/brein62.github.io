    ...
    <article>
      <PageSection title="Awards">
        <p className="big justify">
          ...
          as competitive programming and cyber-security competitions.
        </p>
        <p className="big justify lastp">
          Apart from competitions, I have received several awards and bursaries from external organisations for academic
      ...
      <PageSection title="Academic Achievements">
        <ResumeList>
          ...
          >
            <p className="justify">
              I was the top 5&ndash;10% of the cohort during my Year 3 Sem 2 (<strong>AY2024/2025 Semester 2</strong>)
              and was placed on the <strong>Dean's List</strong> for my faculty during this semester for outstanding
          ...
          >
            <p className="justify">
              I was the top 5&ndash;10% of the cohort during my Year 2 Sem 2 (<strong>AY2023/2024 Semester 2</strong>)
              and was placed on the <strong>Dean's List</strong> for my faculty during this semester for outstanding
              academic performance.
            </p>
            <p className="justify lastp">
          ...
          >
            <p className="justify">
              I was one of the top performers for the module <strong>CS2100 Computer Organisation</strong> (class of
              796) during my Year 2 Sem 1 (<strong>AY2023/2024 Semester 1</strong>). This award distinguishes the top
              students among all students who have attained an A+ for the module.
            </p>
            <p className="justify lastp">
      ...
      <PageSection title="Computer Science Competitions">
        <ResumeList>
          ...
          >
            <p className="justify">
              A student-run hackathon by Developer Student Club NUS that aims for students to use technology to
              contribute to social causes by solving problems faced by non-profit organisations (NPOs). During the
              week-long qualifying round of the hackathon, we developed a prototype full-stack web application using the{' '}
              <span className="moreinfo" title="MongoDB, Express, React, Node.js">
                MERN stack
              </span>{' '}
              as a team of 4 to fit the NPO's requirements. I focused on key backend and frontend components while also
              supporting team members with Git and project structure, ensuring smooth collaboration despite varying
              experience levels.
            </p>
            <p className="justify lastp">
              <LinkButton
                variant="primary"
                newTab={false}
                href="/#projects#muhammadiyah-welfare-home-system-(hack4good-2025)"
          ...
          >
            <p className="justify">
              A competitive programming olympiad hosted by NUS School of Computing, testing participants'
              problem-solving skills in specific programming contexts. Given a problem, participants must try to find a
              solution that not only satisfies all test cases, but fits within time and memory limits imposed. I
              represented my Junior College and achieved a Silver Medal for this competition.
            </p>
            <p className="justify lastp">
              <LinkToAwardButton href="/documents/NOI-2019-Silver.pdf">NOI 2019 Silver Medal</LinkToAwardButton>
            </p>
          </ResumeEntry>
          <ResumeEntry
          ...
          >
            <p className="justify">
              Held as part of the Cyber Defenders Discovery Camp (CDDC) 2019 by Singapore's Defence Science and
              Technology Agency (DSTA), BrainHack is a Jeopardy-style Capture The Flag (CTF), a computer security
              competition where teams compete to solve cybersecurity problems that award points and try to win as many
              points as possible.
            </p>
            <p className="justify">
            ...
            <p className="justify lastp">
              <LinkToAwardButton href="/documents/Brainhack-2019.pdf">Brainhack 2019 Bronze Award</LinkToAwardButton>
            </p>
          </ResumeEntry>
          <ResumeEntry
          ...
          >
            <p className="justify">
              Held by Nanyang Technological University's School of Computer Science and Engineering (NTU SCSE), this
              event was a 2-day hackathon where teams of 4 students from local Junior Colleges created a game using the
              Unity game engine with controls from the Leap motion controller.
            </p>
          </ResumeEntry>
        </ResumeList>
      </PageSection>
      ...
      <PageSection title="Non-Computer Science Competitions">
        <ResumeList>
          ...
          >
            <p className="justify">
              Held annually by the Australian Mathematics Trust every year for students Years 3 to 12 in Australia and
              other countries. I was a Junior College Year 2 student (Year 12 equivalent) at the time of the
              competition. Distinction is awarded to the 80th&ndash;97th percentile of students in each participating
              country.
            </p>
            <p className="justify lastp">
      ...
      <PageSection title="Other Awards and Recognitions">
        <ResumeList>
          <ResumeEntry title="JPJC 'A' Level Inspirational Story 2019" dates="Dec 2019" screenWidth={screenWidth}>
            <p className="justify lastp">
              ...
              <a
                ...
                target="_blank"
                href="https://www.jpjc.moe.edu.sg/accomplishments/students/a-level-inspirational-stories/2020/brendan/"
              >
                here
              </a>
              .
          ...
          <ResumeEntry title="Bursaries and Edusave Awards" dates="2016&ndash;2020" screenWidth={screenWidth}>
            <p className="justify">Awarded by various organisations for my academic performance.</p>
            <ol className="justify">
              <li>
                <strong>LCA 2019 Bursary (Feb 2020):</strong> $200. For good academic performance in Junior College.
              </li>
              <li>
                <strong>Edusave Certificate of Academic Achievement 2019 (2019):</strong> For achieving good academic
                performance and demonstrating good conduct during JC.
              </li>
              <li>
                <strong>Edusave Good Progress Award 2016 (Feb 2016):</strong> $200. For improvement in academic
                performance and demonstrating good conduct in my Secondary School.
              </li>
              <li>
                <strong>Edusave Certificate of Academic Achievement 2016 (Feb 2016):</strong> For achieving good
                academic performance and demonstrating good conduct in my Secondary School.
              </li>
              <li>
                <strong>LCA 2018 Bursary (Feb 2018):</strong> $200. For good academic performance.
              </li>
            </ol>
          </ResumeEntry>
          <ResumeEntry title="Childhood Awards" dates="2011&ndash;2012" screenWidth={screenWidth}>
            <p className="justify">
              During my childhood, I have represented my primary school for Mathematics competitions. It is listed here
              as personal milestone achievements during my primary school days.
            </p>
            <ol className="justify">
              <li>
              ...
              <li>
                <strong>National Mathematics Olympiad of Singapore 2012 (2012):</strong> The National Mathematics
                Olympiad of Singapore was a mathematics competition hosted by NUS High School of Mathematics and
                Science. I was one of the top 4 students from my primary school. My primary school ended up being one of
                the top 10 schools that participated in this olympiad.
              </li>
            </ol>
          </ResumeEntry>
        </ResumeList>
