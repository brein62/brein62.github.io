          ...
          <Col sm={9} id="tab-modules">
            <Tab.Content>
              <Tab.Pane eventKey="Y1">
                <ul>
                  <li>
                    <strong>H1 Project Work: </strong>A
                  </li>
                  <li>
                    <strong>H1 Mother Tongue: </strong>E
                  </li>
                </ul>
              </Tab.Pane>
              <Tab.Pane eventKey="Y2">
                <ul>
                  <li>
                    <strong>H2 Computing: </strong>A
                  </li>
                  <li>
                    <strong>H2 Mathematics: </strong>A
                  </li>
                  <li>
                    <strong>H2 Chemistry: </strong>A
                  </li>
                  <li>
                    <strong>H1 Economics: </strong>A
                  </li>
                  <li>
                    <strong>H1 General Paper: </strong>C
                  </li>
                </ul>
              </Tab.Pane>
            </Tab.Content>
