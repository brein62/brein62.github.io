 ...
 */
export default function LinkButton({ href, direction = "right", icon, variant, newTab = true, children } : { href : string, direction? : string, icon : IconDefinition, variant?: string, newTab?: boolean, children : React.ReactNode }) {
    return (
